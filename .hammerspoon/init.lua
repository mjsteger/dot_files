...
hs.hotkey.bind({"cmd", "alt", "ctrl", "up"}, "left", function()
      local win = hs.window.focusedWindow()
      local f = win:frame()
      local screen = win:screen()
      local max = screen:frame()
...
function test_rescuetime()
   local rt = hs.appfinder.appFromName("RescueTime")
   hs.application.launchOrFocus("RescueTime")
   hs.osascript.applescript('tell application "System Events" to tell process "RescueTime"\
	tell menu bar item 1 of menu bar 2 \
		click menu item "Start Focustime..." of menu 1\
	end tell\
end tell')
   hs.osascript.applescript('tell application "System Events" to tell process "RescueTime" \
...
hs.hotkey.bind({"cmd", "alt", "ctrl"}, 'a', test_rescuetime)
